                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <ul id="links" className='list-unstyled'>
                                ...
                                <li className='nav-item' data-aos="fade-up"  data-aos-duration="1000"><a className='nav-link' href="https://bdking-chalmaraputtmovie.netlify.app/#putt3">https://bdking-chalmaraputtmovie.netlify.app/</a></li>
